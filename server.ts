...
export function app(): express.Express {
  ...
  const distFolder = join(process.cwd(), 'dist/travel-agent/browser');
  ...
  const template = fs
    .readFileSync(
      path.join(join(process.cwd(), 'dist/travel-agent/browser'), 'index.html')
    )
    .toString();
    ...
    res.render(
      ...
      async (err, html) => {
        ...
        var seo: any = {
          ...
          image:
            'https://www.travelagent.tube/assets/images/profile-cover.png',
          site: 'https://www.travelagent.tube/',
          url: 'https://www.travelagent.tube' + params,
        ...
        if (
          ...
          const talent = {
            ...
            image: post?.thumbfilename || post?.metaimage || post?.imageUrl || 'https://www.travelagent.tube/assets/images/profile-cover.png',
          };
          seo.title = talent.name;
          seo.description = strip_html_tags(talent.description);
          seo.image = talent.image;
